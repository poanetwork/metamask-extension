...
import { DAI_CODE, POA_SOKOL_CODE, RSK_TESTNET_CODE, GOERLI_TESTNET_CODE, CELO_ALFAJORES_TESTNET_CODE, CELO_BAKLAVA_TESTNET_CODE } from '../../../app/scripts/controllers/network/enums'
...
class FiatValue extends Component {
  ...
  render = () => {
    ...
    const isTestnet = parseInt(network) === POA_SOKOL_CODE || parseInt(network) === RSK_TESTNET_CODE || parseInt(network) === GOERLI_TESTNET_CODE || parseInt(network) === CELO_ALFAJORES_TESTNET_CODE || parseInt(network) === CELO_BAKLAVA_TESTNET_CODE
